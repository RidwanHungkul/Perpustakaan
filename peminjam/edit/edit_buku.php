              ...
              ?>
                <div class="modal-header">            
                  ...
                  <div class="modal-body">
                    ...
                    <form action="../../proses/proses_edit_buku.php?id=<?= $ruw['id'] ?>" method="post">
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <a href="input/input_kategori.php">
              <button type="button" class="btn btn-primary" style="margin-left:140%;margin-top:-30px;position:absolute;width:153px;">+ Tambah Kategori</button>
            </a>
          </div>            
        </div>
      </div><!-- /.container-fluid -->
            ...
            <?php $i=0; while ($row = mysqli_fetch_assoc($result)) :  $i++; ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="modal/ulasan_buku.php?id=<?=$ruw['id'] ?>" class="btn btn-sm" style="background-color:#FE7A36; color:#fff">Ulas</a>
                    </td>
                </tr>
            <?php endwhile; ?>
        </tbody>
